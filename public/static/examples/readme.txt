...
examples folder symlink to node_modules:

& cmd /c "mklink /J D:\Web\discoverthreejs\markdown\examples .\examples"
...
When comparison mode is enabled, all files have two states, however if .start and .final are not provided, both texts have the same text to start but can be edited/reset separately
