...
export default function addSimpleScrollbar( CodeMirror ) {
  ...
  Bar.prototype.setPos = function( pos, force ) {
    ...
    this.pos = pos;
    this.inner.style[ this.orientation == 'horizontal' ? 'left' : 'top' ] = ( pos * ( this.size / this.total ) ) +
      'px';
    return true;
  };
  ...
  SimpleScrollbars.prototype.update = function( measure ) {
    if ( this.width == null ) {
      const style = window.getComputedStyle ? window.getComputedStyle( this.horiz.node ) : this.horiz.node
        .currentStyle;
